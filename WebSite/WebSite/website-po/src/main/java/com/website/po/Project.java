...
public class Project {
    ...
    public Project(Long id, Long businessId, String projectName, String projectDescription, Byte isVerified, Long budget, Integer tenderPeriod, Integer expectedTime, Date finishTime, Date gmtCreate, Date gmtModified, String skill) {
        this.id = id;
